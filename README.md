...
Window rules may specify a `backdrop` on Windows 11 22621 (October 2023) and later.
- acrylic, apply a transparent blurred effect to the windo background. The effect fades when the window is not focused.
